...
<%@ page import="com.Liuhao.model.User" %>
<section id="z`z`">
	<div class="container">
		<div class="step-one">
						...
						<c:otherwise>
							...
							<c:forEach var="o" items="${orderList}">
								<tr>
									...
									<td class="cart_total">
										<%
											com.ChenJiudong.model.Order o=(com.ChenJiudong.model.Order)pageContext.findAttribute("o");
											int n=o.getPaymentId();
											java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
											String paymentType=com.ChenJiudong.model.Payment.findByPaymentId(con,n);
										%>
